...
const Header = () => {
  ...
  return (
    <header ref={headerRef} className="py-6 flex justify-between items-center max-w-[1600px] mx-auto px-6 w-full">
      ...
      <div>
        <Link className="rounded-full bg-indigo-600 hover:bg-indigo-700 py-2 text-white font-semibold px-6" to="/favorites">
          Ver meus eventos
        </Link>
      </div>
    </header>
